...
class TrainingObservation(models.Model):
    ...
    Project_Name_c =  models.CharField(max_length=100, blank=True, null=True)
    Project_Name_c_slug = models.SlugField()
    Program_c = models.CharField(max_length=100, blank=True, null=True)
    Observation_Location_Latitude_s =  models.FloatField()
    Observation_Location_Longitude_s =  models.FloatField()
    Trainer_c =  models.CharField(max_length=100, null=True, blank=True)
...
class TrainingSession(models.Model):
    ...
    Training_Group_c = models.CharField(max_length=100,blank=True, null=True)
    Trainer_c = models.CharField(max_length=100, blank=True, null=True)
...
class FarmVisit(models.Model):
    ...
    Date_Visited_c = models.DateField(blank=True, null=True)
    Location_GPS_Latitude_s = models.FloatField(blank=True, null=True)
    Location_GPS_Longitude_s = models.FloatField(blank=True, null=True)
    Farmer_Trainer_c = models.CharField(max_length=100, blank=True, null=True)
    Training_Group_c = models.CharField(max_length=100,blank=True, null=True)
    Program_c = models.CharField(max_length=100, blank=True, null=True)
